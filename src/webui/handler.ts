              ...
              <tbody class="divide-y divide-slate-700/50">
                ...
                ` : files.map(f => html`
                  <tr class="hover:bg-slate-800/30 transition-colors">
                    ...
                    <td class="p-4 text-sm text-slate-400">${f.date}</td>
                    <td class="p-4 text-right">
                      ...
                      <button onclick="deleteFile(this.dataset.name)" data-name="${f.name}" class="px-3 py-1 bg-crimson/20 text-crimson hover:bg-crimson hover:text-white text-xs rounded transition-colors border border-crimson/30">Delete</button>
                    </td>
                  </tr>
                `)}
              </tbody>
